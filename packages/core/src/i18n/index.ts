...
const en = { ...en_common, ...en_library, ...en_reader, ...en_notes, ...en_settings, ...en_tts, ...en_stats, ...en_onboarding, ...en_profile, ...en_misc };
const zh = { ...zh_common, ...zh_library, ...zh_reader, ...zh_notes, ...zh_settings, ...zh_tts, ...zh_stats, ...zh_onboarding, ...zh_profile, ...zh_misc };
const zhTW = { ...zhTW_common, ...zhTW_library, ...zhTW_reader, ...zhTW_notes, ...zhTW_settings, ...zhTW_tts, ...zhTW_stats, ...zhTW_onboarding, ...zhTW_profile, ...zhTW_misc };
const ja = { ...ja_common, ...ja_library, ...ja_reader, ...ja_notes, ...ja_settings, ...ja_tts, ...ja_stats, ...ja_onboarding, ...ja_profile, ...ja_misc };
const ko = { ...ko_common, ...ko_library, ...ko_reader, ...ko_notes, ...ko_settings, ...ko_tts, ...ko_stats, ...ko_onboarding, ...ko_profile, ...ko_misc };
const fr = { ...fr_common, ...fr_library, ...fr_reader, ...fr_notes, ...fr_settings, ...fr_tts, ...fr_stats, ...fr_onboarding, ...fr_profile, ...fr_misc };
const es = { ...es_common, ...es_library, ...es_reader, ...es_notes, ...es_settings, ...es_tts, ...es_stats, ...es_onboarding, ...es_profile, ...es_misc };
